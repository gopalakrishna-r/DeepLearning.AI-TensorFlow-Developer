...
from preprocessor import create_model_inputs,  encode_inputs_with_lookups
...
def create_bl_model(hidden_units, dropout, csv_feature_names):
    ...
    features = encode_inputs_with_lookups(inputs, csv_feature_names)
