...
def process_sequence(training_sentences, testing_sentences,
                     vocab_size,
                     max_length,
                     trunc_type,
                     padding_type,
    ...
    testing_padded = pad_sequences(testing_seq, maxlen=max_length, truncating=trunc_type, padding=padding_type)
